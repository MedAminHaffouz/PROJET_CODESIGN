#
# Matrix Multiplication: Local Memory Tiling (myGEMM2)
#
from helper import *
...
# --------------------------------------------------------------------------------
kernel_name = "C_myGEMM2.cl"

print (f"Matrix multiplication {N}*{N} repeated {COUNT} times")
print (f"Executing kernel: {kernel_name} (Local Memory Tiling)\n")
...
for i in range(COUNT):    
    try:
        # Standard Global and Local mappings (1 thread per element)
        global_dim = (N, N)
        local_dim = (localsize, localsize)
